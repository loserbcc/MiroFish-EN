...
// Get maxRounds from query params at init, ensuring child components get the value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh doesn't show full loading to avoid flickering
