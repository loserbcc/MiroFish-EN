            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if University X revokes Student Y's disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
