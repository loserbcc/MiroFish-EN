    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are auto-chunked, then Zep builds the knowledge graph, extracts entities and relations, and forms temporal memory and community summaries
          </p>
