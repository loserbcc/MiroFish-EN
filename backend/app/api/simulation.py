...
# Adding this prefix prevents Agent from calling tools, replies directly with text
...
def prepare_simulation():
    ...
    try:
        ...
        # This way frontend can get the expected total Agent count immediately after calling prepare
        try:
            logger.info(f"Synchronously getting entity count: graph_id={state.graph_id}")
            reader = ZepEntityReader()
            # Quick read entities (no edge info needed, only count)
...
def start_simulation():
    ...
    About force parameter:
        ...
        - Suitable for scenarios that require re-running simulation
...
def get_run_status_detail(simulation_id: str):
    ...
    try:
        ...
        # recent_actions shows only current latest round content from both platforms
