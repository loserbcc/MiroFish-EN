...
Maintains consistency with existing code logic to ensure backward compatibility.
"""
...
class ZepCloudClient(ZepClientAdapter):
    ...
    Wraps the zep-cloud SDK, converting native API responses to adapter data structures.
    """
    ...
    def set_ontology(
        ...
        Passes directly to the Zep Cloud API; entities and edges should be pre-built dynamic classes.
        """
    ...
    def _convert_node(self, node: Any) -> GraphNode:
        """Convert a Zep Node object to GraphNode"""
    ...
    def _convert_edge(self, edge: Any) -> GraphEdge:
        """Convert a Zep Edge object to GraphEdge"""
        # Process time fields
