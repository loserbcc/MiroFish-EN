...
class AgentActivity:
    ...
    def _describe_create_comment(self) -> str:
        """Post a comment - includes comment content and the commented post info"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, sending in batches to Zep after accumulating BATCH_SIZE activities.
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        Args:
            ...
            api_key: Zep API Key (optional, deprecated, using factory pattern)
        """
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains complete context information (such as original post text, usernames, etc.).
