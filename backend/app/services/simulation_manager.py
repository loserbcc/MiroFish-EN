...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified status dictionary (for API response)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation configuration parameters (timing, activity level, posting frequency, etc.)
        ...
        try:
            ...
            # Reddit already saved in real-time during generation, save again here to ensure completeness
            if progress_callback:
                progress_callback(
